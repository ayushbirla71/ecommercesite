        ...
        <div className="payment">
          ...
          >
            ...
            <div className="form-group" id="credit_cards">
              <img
                src="https://www.idealshyambazar.com/wp-content/uploads/2020/06/06cd1a3c_rupay-logo.jpg"
                style={{ height: "60px" }}
                id="amex"
              />
              <img
                src="https://cdn0.iconfinder.com/data/icons/major-credit-cards-colored/48/JD-14-512.png"
                style={{ height: "60px" }}
                id="mastercard"
              />
              <img
